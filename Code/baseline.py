...
f = open('E:/WashU/Research/ICU/Data/train/X_train_sliced.pkl','rb')
...
f = open('E:/WashU/Research/ICU/Data/test1/X_test1_sliced.pkl','rb')
X_test1_sliced = pickle.load(f)
f.close()
f = open('E:/WashU/Research/ICU/Data/test1/y_test1.pkl','rb')
y_test1 = pickle.load(f)
f.close()
f = open('E:/WashU/Research/ICU/Data/test1/test1_mask_mat.pkl','rb')
test1_mask_mat = pickle.load(f)
f.close()

f = open('E:/WashU/Research/ICU/Data/test2/X_test2_sliced.pkl','rb')
X_test2_sliced = pickle.load(f)
f.close()
f = open('E:/WashU/Research/ICU/Data/test2/y_test2.pkl','rb')
y_test2 = pickle.load(f)
f.close()
f = open('E:/WashU/Research/ICU/Data/test2/test2_mask_mat.pkl','rb')
test2_mask_mat = pickle.load(f)
f.close()

f = open('E:/WashU/Research/ICU/Data/mean.pkl','rb')
mean = pickle.load(f)
f.close()
